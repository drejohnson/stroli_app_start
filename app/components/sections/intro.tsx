...
export const Intro: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className='relative h-screen snap-start snap-always overflow-clip'>
      <div ref={videoRef} className='size-full'>
        <VideoBackground
          src="https://assets.stroli.io/videos/output-1440p-2btr-bg-video.mp4"
          fallbackImage="https://assets.stroli.io/images/hero.jpg"
          inViewOptions={{ amount: 0.3 }}
        >
          <h1 ref={headingRef} className="flex flex-col gap-4 w-full text-[clamp(1.75rem,8vw,3rem)] font-display font-extrabold uppercase leading-none text-white md:self-start p-2 mb-4 translate-y-[-100px] opacity-0">
          ...
          <div className="flex flex-col gap-4">
            <p ref={pRef} className="text-xl text-gray-50 text-balance translate-x-[-100px] opacity-0">
